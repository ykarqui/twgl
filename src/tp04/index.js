...
scene.addMesh(new Mesh(new Cube(), matCube, 'Cube', true))
console.info('Cube created')

var matSphere = new Material([0.0 * 255, 1 * 255, 0.0 * 255], [1.0 * 255, 1.0 * 255, 1.0 * 255], 0.5)
scene.addMesh(new Mesh(new Sphere(), matSphere, 'Sphere', false))
